<template>
    <section style="position: absolute; z-index: 1; top: 0; width: 100%;">
        <div class="position-relative" style="height: 100px; z-index: 1; background-color: transparent;">
                        ...
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 d-flex align-items-center">
                            ...
                            <li class="me-4 nav-item dropdown text-capitalize">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <routerLink class="dropdown-item" to="/BlogLeftSideBar">blog left sidebar
                                        </routerLink>
                                    </li>
                                    <li>
                                        <routerLink class="dropdown-item" to="/BlogRightSideBar">blog right sidebar
                                        </routerLink>
                                    </li>
                                    <li>
